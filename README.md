...
### How to Run
1. Ensure image.npz and labels.csv are in the project directory.
2. Install dependencies:
3. pip install opencv-python numpy pandas scikit-learn pillow
4. Run the script:
python alphabet_detection.py
5. Place a handwritten capital letter inside the green box shown on the camera feed to see the prediction displayed in the console.
